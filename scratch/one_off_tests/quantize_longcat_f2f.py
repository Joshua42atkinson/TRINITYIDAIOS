...
OUTPUT_PATH = "/home/joshua/trinity-models/omni/LongCat-Next-INT4"
DEVICE = "cpu"
SCHEME = "int4_wo_128"  # INT4 weight-only, group_size=128
...
if os.path.exists(output_config_path):
    ...
    print("[✓] config.json successfully inoculated with native AWQ schema.")
